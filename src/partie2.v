...
Inductive beta_reduction_one_step : DeBruijn -> DeBruijn -> Prop :=
    | Evaluation : forall (u: DeBruijn), forall (v: DeBruijn), 
        (beta_reduction_one_step (Application (Lambda u) v) (u[0 <- v]))
    | Context_r : forall (u: DeBruijn), forall (v: DeBruijn), forall (w: DeBruijn),
        (beta_reduction_one_step v w) -> 
            (beta_reduction_one_step (Application u v) (Application u w))
    | Context_l : forall (u: DeBruijn), forall (v: DeBruijn), forall (w: DeBruijn),
        (beta_reduction_one_step u v) -> 
            (beta_reduction_one_step (Application u w) (Application v w))
    | Context_lambda : forall (u: DeBruijn), forall (v: DeBruijn),
...
Inductive beta_reduction : DeBruijn -> DeBruijn -> Prop :=
    ...
    | beta_trans : forall (t: DeBruijn), forall (u: DeBruijn), forall (v: DeBruijn),
...
Theorem context_l_star : forall (t:DeBruijn), forall (u: DeBruijn), forall (v: DeBruijn),
...
Theorem context_r_star : forall (t:DeBruijn), forall (u: DeBruijn), forall (v: DeBruijn),
...
Theorem context_lambda_star : forall (t: DeBruijn), forall (u: DeBruijn),
